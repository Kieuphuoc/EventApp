    ...
    <View style={styles.container}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailTextContainer}>
                ...
                <Text style={styles.detailValue}>{paymentDetails.eventName}</Text>
              </View>
            </View>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailTextContainer}>
                ...
                <Text style={styles.detailValue}>{paymentDetails.date} at {paymentDetails.time}</Text>
              </View>
            </View>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailTextContainer}>
                ...
                <Text style={styles.detailValue}>{paymentDetails.venue}</Text>
              </View>
            </View>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailTextContainer}>
                ...
                <Text style={styles.detailValue}>{paymentDetails.ticketType}</Text>
              </View>
            </View>
            ...
            <View style={styles.priceContainer}>
              ...
              <Text style={styles.priceValue}>${paymentDetails.pricePerTicket}</Text>
            </View>

            <View style={styles.totalContainer}>
              <Text style={styles.totalLabel}>Total Amount</Text>
              <Text style={styles.totalValue}>${paymentDetails.totalAmount}</Text>
            </View>
          </View>
        </View>
      </ScrollView>
      ...
      <View style={styles.footer}>
        <View style={styles.footerTotalContainer}>
          ...
          <Text style={styles.footerTotalValue}>${paymentDetails.totalAmount}</Text>
        </View>
        <TouchableOpacity
